        ...
        <div>
          ...
          <ul className="sidebar-icons rarity">
            {rarity.map((element, index) =>
                <li onClick={this.handleClick.bind(this, index)} className={element.en} value={element[index]} key={index}>
                  <IconsWrapper active={this.state.active} icon_name="rarity" element_name={element.en} label={element.pl} index={index}/>
                </li>
            )}
          </ul>
        </div>
