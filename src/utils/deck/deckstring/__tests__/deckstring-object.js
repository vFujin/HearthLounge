...
describe('prepares deck to be ready for deckstring conversion', () => {
  ...
  const testDeckToDeckstringObj = (
    ...
    test(`converts ${testingPlayerClass} deck, ${testingPlayerClass} playerClass and ${testingMode} mode to deckstring object`, () => {
      let eStringifiedValue = JSON.stringify(
        setDeckstringObj(deck, testingPlayerClass, testingMode)
      );
  ...
  testDeckToDeckstringObj(test_deck_1, test_playerClass_1, test_mode_1, {
    cards: [[216, 2], [739, 1], [906, 1], [284, 2], [1361, 1]],
    heroes: [813],
    format: 1,
  });
  testDeckToDeckstringObj(test_deck_1, test_playerClass_1, test_mode_2, {
    cards: [[216, 2], [739, 1], [906, 1], [284, 2], [1361, 1]],
    heroes: [813],
    format: 1,
  });
  testDeckToDeckstringObj(test_deck_1, test_playerClass_1, test_mode_3, {
    cards: [[216, 2], [739, 1], [906, 1], [284, 2], [1361, 1]],
    heroes: [813],
    format: 2,
  });
  testDeckToDeckstringObj(test_deck_1, test_playerClass_1, test_mode_4, {
    cards: [[216, 2], [739, 1], [906, 1], [284, 2], [1361, 1]],
    heroes: [813],
    format: 1,
  });

  testDeckToDeckstringObj(test_deck_2, test_playerClass_2, test_mode_1, {
    cards: [[785, 1], [940, 2], [739, 1], [284, 1]],
    heroes: [7],
    format: 1,
  });
  testDeckToDeckstringObj(test_deck_2, test_playerClass_2, test_mode_2, {
    cards: [[785, 1], [940, 2], [739, 1], [284, 1]],
    heroes: [7],
    format: 1,
  });
  testDeckToDeckstringObj(test_deck_2, test_playerClass_2, test_mode_3, {
    cards: [[785, 1], [940, 2], [739, 1], [284, 1]],
    heroes: [7],
    format: 2,
  });
  testDeckToDeckstringObj(test_deck_2, test_playerClass_2, test_mode_4, {
    cards: [[785, 1], [940, 2], [739, 1], [284, 1]],
    heroes: [7],
    format: 1,
  });
