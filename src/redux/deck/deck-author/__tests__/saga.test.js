  ...
  describe('#fetchDeckAuthorSaga', () =>{
    ...
    describe('when success', () =>{
      test('should dispatch success action', () =>{
        ...
        expect(saga.next(response).value).toEqual(put(actions.fetchDeckAuthorSuccess(response.deckAuthor)))
      });
    });
    ...
    describe('when error', () =>{
      test('should dispatch an error action', () =>{
        ...
        expect(saga.next().value).toEqual(call(fetchDeckAuthor, payload));
        expect(saga.next(response).value).toEqual(put(actions.fetchDeckAuthorFailure(response.err)))
      });
    });
  })
});