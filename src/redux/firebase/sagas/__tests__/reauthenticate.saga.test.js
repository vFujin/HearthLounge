  ...
  describe('#firebaseReauthenticate', () =>{
    ...
    describe('when success', () =>{
      ...
      test('should dispatch success action', () =>{
        ...
        expect(saga.next().value).toEqual(call(firebaseReauthenticate, payload));
        expect(saga.next(response).value).toEqual(put(actions.firebaseReauthenticateSuccess(response.reauthenticated)))
      });
