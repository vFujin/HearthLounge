...
class DeckMobile extends Component {
  ...
  content = params => {
    switch (this.state.activeMobileTab) {
      case 'aboutAuthor':
        return <DeckAuthorDetails />;
      case 'guide':
        return <DeckDescription />;
      case 'comments':
        return <DeckComments params={params} />;
      default:
        return <DeckDetails />;
    }
  };
  ...
  render() {
    ...
    return (
      <div className="container__page container__page--mobile deck">
        <MobileTopbar
          tabs={['aboutAuthor', 'deckDetails', 'guide', 'comments']}
          activeMobileTab={activeMobileTab}
          handleTabClick={this.handleMobileTopbarTabClick}
        />
        <div className="container__page--right">
          <div className="content">
            <div className="container__details">{this.content(params)}</div>
          </div>
        </div>
      </div>
    );
