...
class DeckSelection extends Component {
  ...
  handleDeckSnippetClick = e => {
    ...
    let deckObject = this.props.decks.all.find(
      deckObject => deckObject.deckId === deckId
    );
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    toggleAdventureFilters: payload =>
      dispatch({
        type: 'TOGGLE_ADVENTURE_FILTERS',
        payload,
      }),
    updateModeFilter: payload =>
      dispatch({
        type: 'UPDATE_MODE_FILTER',
        payload,
      }),
    updateAdventureFilter: payload =>
      dispatch({
        type: 'UPDATE_ADVENTURE_FILTER',
        payload,
      }),
    updateClassFilter: payload =>
      dispatch({
