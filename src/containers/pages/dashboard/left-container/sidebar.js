...
import {
  updateEmail,
  updateHearthstoneData,
  updateSocialMediaData,
} from '../../../../firebase/user/update';
...
class Sidebar extends PureComponent {
  ...
  handleSaveClick = e => {
    ...
    switch (target) {
      ...
      case 'hearthstone':
        return updateHearthstoneData(
          uid,
          validateInput('battletag'),
          validateInput('favouriteClass'),
          validateInput('region')
        );
      case 'social_media':
        return updateSocialMediaData(
          uid,
          validateInput('facebook'),
          validateInput('twitter'),
          validateInput('twitch'),
          validateInput('youtube')
        );
      default:
        return target;
    }
        ...
        <div className="sidebar__body">
          ...
          <ul>
            ...
            <HearthstoneDetails
              ...
              handleInputChange={e => this.handleInputChange(e)}
              handleSelectChange={(v, selector) =>
                this.handleSelectChange(v, selector)
              }
              handleSaveClick={this.handleSaveClick}
            />
            <SocialMediaDetails
            ...
            />
            <DangerZone
              isEditing={this.state.editing_delete_account}
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    reauthenticate: (email, password) =>
      dispatch({
        type: FIREBASE_REAUTHENTICATE_REQUEST,
