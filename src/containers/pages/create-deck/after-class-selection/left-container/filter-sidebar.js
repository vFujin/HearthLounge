...
const FilterSidebar = ({
  ...
  return (
    <div className="sidebar__body">
      ...
      <IconFilter
        header={true}
        headerLabel="standard set"
        filter="cardSet"
        value={cardStandardSet}
        wrapperClass="sidebar-icons"
        isStandard={true}
        handleIconClick={handleIconClick}
      />
      <IconFilter
        header={true}
        headerLabel="wild set"
        filter="cardSet"
        value={cardWildSet}
        wrapperClass="sidebar-icons"
        isStandard={false}
...
const mapDispatchToProps = dispatch => {
  return {
    updateDeckCreationFilters: deckCreationFilters =>
      dispatch(updateDeckCreationFilters(deckCreationFilters)),
  };
};
