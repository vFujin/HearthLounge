...
class Topbar extends Component {
  toggleActiveClass = (e, state, siblingId) => {
    ...
    state ? (targetId.className += 'active') : (targetId.className = '');
  };
  ...
  handleDeckImport = () => {
    ...
    createDeckFromDeckstringObj(
      ...
      importedDeckstring,
      deck => editDeck(deck),
      simplifiedDeck => simplifyDeck(simplifiedDeck),
  ...
  handleOptionsClick = (e, icon) => {
    topbarOptions(
      ...
      icon,
      this.props,
      this.handleCopyDeckStringClick,
      this.switchDecklistClasses,
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    showDeckEditingTool: editingTool =>
      dispatch(showDeckEditingTool(editingTool)),
    toggleImgReadyDecklist: decklist =>
      dispatch(toggleImgReadyDecklist(decklist)),
    toggleImportedDeckstringPopover: deckstring =>
      dispatch(toggleImportedDeckstringPopover(deckstring)),
