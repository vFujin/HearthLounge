...
const StatsOptions = ({deck, activeClass, handleOptionsClick, handleImgSaveClick, filtersActive}) => {
  ...
  return (
      <div className={`topbar__container topbar__deckDetails`}>
        ...
        <MapFunctionfulIcons set="options" handleOptionsClick={handleOptionsClick} handleImgSaveClick={handleImgSaveClick}/>
      </div>
  )
};
